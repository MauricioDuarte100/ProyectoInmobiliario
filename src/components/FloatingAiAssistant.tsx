    ...
    <div className="fixed bottom-6 right-6 z-50">
          ...
          >
            <div className="flex items-center justify-between border-b border-border/60 px-5 py-4">
              <div className="flex items-center gap-2">
                <motion.div
                  className="grid h-8 w-8 place-items-center rounded-full bg-green-trust text-white"
                ...
                >
                  <div className="max-w-[85%] rounded-2xl rounded-bl-sm bg-slate-50 px-4 py-2.5">
                    <div className="flex items-center gap-1.5">
                      <span className="h-2.5 w-2.5 bounce-dot rounded-full bg-green-trust/60" />
                      <span className="h-2.5 w-2.5 bounce-dot rounded-full bg-green-trust/60" />
                      <span className="h-2.5 w-2.5 bounce-dot rounded-full bg-green-trust/60" />
                    </div>
                  </div>
            ...
            <div className="border-t border-border/60 px-4 py-3">
              <div className="flex items-center gap-2">
                ...
                <motion.button
                  ...
                  disabled={isLoading}
                  whileTap={{ scale: 0.9 }}
                  className="grid h-9 w-9 place-items-center rounded-xl bg-green-trust text-white hover:bg-green-trust/90 transition-colors disabled:opacity-50"
      ...
      <motion.button
        ...
        className={`grid h-14 w-14 place-items-center rounded-full shadow-[0_12px_40px_rgba(31,138,91,0.35)] transition-colors duration-300 ${
          !isOpen ? 'bg-green-trust text-white fab-bounce' : 'bg-night text-white'
        }`}
